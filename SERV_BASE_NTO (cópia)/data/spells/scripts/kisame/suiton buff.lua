...
function magicEffect13(tempo2,tempo3,cid)
...
doPlayerSendTextMessage(cid,27,'Suiton buff no jutsu esta ativado.') 
    doPlayerSay(cid, 'Suiton Buff!', TALKTYPE_ORANGE_1)
    tempo2 = 0
    while (tempo2 ~= (tempo*1000)) do
        addEvent(magicEffect13, tempo2, tempo2, tempo*1000, cid)
        tempo2 = tempo2 + 300
    end
