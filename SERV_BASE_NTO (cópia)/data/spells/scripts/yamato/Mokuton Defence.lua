...
function Effect91(tempo2,tempo3,cid)
...
doPlayerSendTextMessage(cid,27,'Mokuton defence esta ativado.') 
    doPlayerSay(cid, 'Mokuton defence!', TALKTYPE_ORANGE_1)
    tempo2 = 0
    while (tempo2 ~= (tempo*1000)) do
        addEvent(Effect91, tempo2, tempo2, tempo*1000, cid)
        tempo2 = tempo2 + 300
    end
