...
node1:addChildKeyword({'yes'}, StdModule.learnSpell, {npcHandler = npcHandler, premium = false, spellName = 'Hokage Impulse', vocation = 10, price = 170, level = 120})
...
node3:addChildKeyword({'yes'}, StdModule.learnSpell, {npcHandler = npcHandler, premium = false, spellName = 'Hokage Tensei!', vocation = 10, price = 500, level = 120})
