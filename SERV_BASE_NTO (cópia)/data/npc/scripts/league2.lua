...
local pokemons = {
{name = "Shiny Gengar", optionalLevel = 350, sex = SEX_MALE, nick = "Gengar", ball = "super"},
{name = "Tyranitar", optionalLevel = 350, sex = SEX_FEMALE, nick = "Tyra", ball = "normal"},
{name = "Misdreavus", optionalLevel = 350, sex = SEX_MALE, nick = "Miss", ball = "great"},
{name = "Gengar", optionalLevel = 350, sex = SEX_MALE, nick = "Gengar", ball = "normal"},
{name = "Shiny Nidoking", optionalLevel = 350, sex = SEX_FEMALE, nick = "King", ball = "ultra"},
{name = "Shiny Muk", optionalLevel = 350, sex = SEX_FEMALE, nick = "Muk", ball = "ultra"},
}
...
local function doWinDuel(cid, npc)
	...
	local this = npc
	setPlayerStorageValue(cid, 63453, 1)
