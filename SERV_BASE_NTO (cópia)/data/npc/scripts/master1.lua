...
local pokemons = {
{name = "Shiny Dragonite", optionalLevel = 1500, sex = SEX_MALE, nick = "Dragonite", ball = "super"},
{name = "Shiny Snorlax", optionalLevel = 1500, sex = SEX_FEMALE, nick = "Snorlax", ball = "normal"},
{name = "Shiny Gyarados", optionalLevel = 1500, sex = SEX_MALE, nick = "Gyarados", ball = "great"},
{name = "Shiny Scyther", optionalLevel = 1500, sex = SEX_MALE, nick = "Scyther", ball = "normal"},
{name = "Shiny Golbat", optionalLevel = 1500, sex = SEX_FEMALE, nick = "Golbat", ball = "ultra"},
{name = "Shiny Venusaur", optionalLevel = 1500, sex = SEX_FEMALE, nick = "Venusaur", ball = "ultra"},
}
...
local function doWinDuel(cid, npc)
	...
	local this = npc
	setPlayerStorageValue(cid, 63451, 1)
