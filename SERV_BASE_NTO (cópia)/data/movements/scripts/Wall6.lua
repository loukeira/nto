...
local pos = {x=1724, y=1503, z=7} -- position em que sera adicionado a parede
local WallId = 6840 -- ID da parede
local storage = 35875 -- storage do piso que ira adicionar a parede (a mesma que sera colocado na TAG)
