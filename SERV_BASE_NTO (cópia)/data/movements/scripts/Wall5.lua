...
local pos = {x=1722, y=1503, z=7} -- position em que sera adicionado a parede
local WallId = 6840 -- ID da parede
local storage = 35874 -- storage do piso que ira adicionar a parede (a mesma que sera colocado na TAG)
