function onUse(cid, item, fromPosition, itemEx, toPosition) 
            ...
            doCreatureSay(itemEx.uid, "REPORTADO!", TALKTYPE_ORANGE_1) 
        ...
        if os.time() > getPlayerStorageValue(cid, 14001) then
              ...
              local coco = getThingPos(itemEx.uid)
                local k = 1
                ...
                file:write(getCreatureName(cid)..": BUG NESSA CORDENADA! "..["..x..","..y..","..z.."].."\n")
                                file:close()
                doPlayerSendTextMessage(cid, MESSAGE_STATUS_WARNING,'Voce Reportou o bug com sucesso!')

                doSendMagicEffect(getThingPos(itemEx.uid), 4)
