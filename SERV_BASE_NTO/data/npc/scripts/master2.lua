...
local pokemons = {
{name = "Pikachu", optionalLevel = 20000, sex = SEX_MALE, nick = "Pikachu", ball = "super"},
{name = "Charizard", optionalLevel = 2000, sex = SEX_FEMALE, nick = "Charizard", ball = "normal"},
{name = "Tauros", optionalLevel = 2000, sex = SEX_MALE, nick = "Tauros", ball = "great"},
{name = "Noctowl", optionalLevel = 2000, sex = SEX_MALE, nick = "Noctowl", ball = "normal"},
{name = "Muk", optionalLevel = 2000, sex = SEX_FEMALE, nick = "Muk", ball = "ultra"},
{name = "Shiny Snorlax", optionalLevel = 2000, sex = SEX_FEMALE, nick = "Snorlax", ball = "ultra"},
}
...
local function doWinDuel(cid, npc)
	...
	local this = npc
	setPlayerStorageValue(cid, 63450, 1)
