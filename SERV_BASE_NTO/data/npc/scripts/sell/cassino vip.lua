...
local moeda = 824
local t = {
   ["kurama helmet"] = {80, 853}, -- ["nome do item"] = {quanto vai custar, id do tem que sera vendido}
   ["kurama armor"] = {80, 852},
   ["kurama boots"] = {10, 856},
   ["kurama legs"] = {80, 854},
   ["akatsuki ring"] = {40, 105},
   ["semana premium"] = {60, 3277},
   ["pergaminho pain"] = {100, 119},
   }
...
elseif t[msg] then
                if doPlayerRemoveItem(cid,t[msg][1]) then
getPlayerStorageValue(cid, 23254
						setPlayerStorageValue(cid, 23254, getPlayerStorageValue(cid, 23254))
