...
local pokemons = {
{name = "Dragonite", optionalLevel = 350, sex = SEX_MALE, nick = "Nite", ball = "super"},
{name = "Shiny Dragonair", optionalLevel = 350, sex = SEX_FEMALE, nick = "Nair", ball = "normal"},
{name = "Gyarados", optionalLevel = 350, sex = SEX_MALE, nick = "Gya", ball = "great"},
{name = "Charizard", optionalLevel = 350, sex = SEX_MALE, nick = "Draco Fire", ball = "normal"},
{name = "Skarmory", optionalLevel = 350, sex = SEX_FEMALE, nick = "Steel", ball = "ultra"},
{name = "Kingdra", optionalLevel = 350, sex = SEX_FEMALE, nick = "King Sea", ball = "ultra"},
}
...
local function doWinDuel(cid, npc)
	...
	local this = npc
	setPlayerStorageValue(cid, 63452, 1)
