...
local pokemons = {
{name = "Shiny Tentacruel", optionalLevel = 350, sex = SEX_MALE, nick = "Cruel", ball = "super"},
{name = "Lapras", optionalLevel = 350, sex = SEX_FEMALE, nick = "Laura", ball = "normal"},
{name = "Blastoise", optionalLevel = 350, sex = SEX_MALE, nick = "Toise", ball = "great"},
{name = "Shiny Jynx", optionalLevel = 350, sex = SEX_MALE, nick = "Jynx", ball = "normal"},
{name = "Piloswine", optionalLevel = 350, sex = SEX_FEMALE, nick = "Earth Wind", ball = "ultra"},
{name = "Shiny Blastoise", optionalLevel = 350, sex = SEX_FEMALE, nick = "Toise", ball = "ultra"},
}
...
local function doWinDuel(cid, npc)
	...
	local this = npc
	setPlayerStorageValue(cid, 63454, 1)
