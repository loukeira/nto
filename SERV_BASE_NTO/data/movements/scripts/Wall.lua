...
local pos = {x=1026, y=910, z=7} -- position em que sera adicionado a parede
local WallId = 6840 -- ID da parede
local storage = 35869 -- storage do piso que ira adicionar a parede (a mesma que sera colocado na TAG)
