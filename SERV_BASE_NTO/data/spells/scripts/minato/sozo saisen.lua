...
local effect = {67} -- effect no player
        
local ml = 70 -- quantos ira aumentar o skill de ML
local skillfist = 70 -- quantos ira aumentar o skill de Fist
local skillsword = 70 -- quantos ira aumentar o skill de Sword
local skillaxe = 70 -- quantos ira aumentar o skill de Axe
local skillclub = 70 -- quantos ira aumentar o skill de Club
local skilldistance = 70 -- quantos ira aumentar o skill de Distance
local skillshield = 70 -- quantos ira aumentar o skill de Shield
...
function magicEffect585858(tempo2,tempo3,cid)
...
if getPlayerStorageValue(cid, 102053) ~= 1 or getCreatureCondition(cid, CONDITION_REGENERATION, 1) == false then
        ...
        while (tempo2 ~= (tempo*1000)) do
                addEvent(magicEffect585858, tempo2, tempo2, tempo*1000, cid)
                tempo2 = tempo2 + 300
        end
