...
local clone = doCreateMonster("Yugito Nii", playerpos)
local clone1 = doCreateMonster("Fuu", playerpos)
local clone2 = doCreateMonster("Utakata", playerpos)
local clone3 = doCreateMonster("Roshi", playerpos)
local clone4 = doCreateMonster("Han", playerpos)
