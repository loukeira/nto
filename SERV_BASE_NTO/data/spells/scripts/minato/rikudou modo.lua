...
local effect = {46} -- effect no player
        
local ml = 80 -- quantos ira aumentar o skill de ML
local skillfist = 80 -- quantos ira aumentar o skill de Fist
local skillsword = 80 -- quantos ira aumentar o skill de Sword
local skillaxe = 80 -- quantos ira aumentar o skill de Axe
local skillclub = 80 -- quantos ira aumentar o skill de Club
...
function magicEffect58686(tempo2,tempo3,cid)
...
if getPlayerStorageValue(cid, 102053) ~= 1 or getCreatureCondition(cid, CONDITION_REGENERATION, 1) == false then
        ...
        while (tempo2 ~= (tempo*1000)) do
                addEvent(magicEffect58686, tempo2, tempo2, tempo*1000, cid)
                tempo2 = tempo2 + 300
        end
