...
setCombatFormula(combat1, COMBAT_FORMULA_LEVELMAGIC, -7.3, 1, -7.5, 1)

local combat2 = createCombatObject()
setCombatParam(combat2, COMBAT_PARAM_TYPE, COMBAT_PHYSICALDAMAGE)
setCombatParam(combat2, COMBAT_PARAM_EFFECT, 190)
setCombatFormula(combat2, COMBAT_FORMULA_LEVELMAGIC, -7.3, 1, -7.5, 1)

local combat3 = createCombatObject()
setCombatParam(combat3, COMBAT_PARAM_TYPE, COMBAT_PHYSICALDAMAGE)
setCombatParam(combat3, COMBAT_PARAM_EFFECT, 190)
setCombatFormula(combat3, COMBAT_FORMULA_LEVELMAGIC, -7.3, 1, -7.5, 1)

local combat4 = createCombatObject()
setCombatParam(combat4, COMBAT_PARAM_TYPE, COMBAT_PHYSICALDAMAGE)
setCombatParam(combat4, COMBAT_PARAM_EFFECT, 190)
setCombatFormula(combat4, COMBAT_FORMULA_LEVELMAGIC, -7.3, 1, -7.5, 1)
