...
setCombatFormula(combat1, COMBAT_FORMULA_LEVELMAGIC, -13.4, 1, -12.5, 1)
...
setCombatFormula(combat3, COMBAT_FORMULA_LEVELMAGIC, -13.4, 1, -12.5, 1)
...
setCombatFormula(combat5, COMBAT_FORMULA_LEVELMAGIC, -13.3, 1, -12.5, 1)

local combat6 = createCombatObject()
setCombatParam(combat6, COMBAT_PARAM_TYPE, COMBAT_PHYSICALDAMAGE)
setCombatParam(combat6, COMBAT_PARAM_EFFECT, 214)
setCombatParam(combat6, COMBAT_PARAM_DISTANCEEFFECT, 1)
setCombatFormula(combat6, COMBAT_FORMULA_LEVELMAGIC, -13.3, 1, -12.5, 1)
