...
efeitoDamage = 41, -- efeito q ira aparecer ao hitar no alvo
hits = 4, -- quantos hits vai dar
delay = 200, -- intervalo de tempo a cada hit
min = 38000, -- dano minimo
max = 47500, -- dano maximo
...
spell7 = {
start7 = function (cid, target, markpos, hits)
    ...
    addEvent(spell7.start7, config.delay, cid, target, markpos, hits - 1)
   end
}
...
if target then
  spell7.start7(cid, target, getThingPos(cid), config.hits)
