...
setCombatFormula(combat3, COMBAT_FORMULA_LEVELMAGIC, -22.3, 1, -27.5, 1)

local combat4 = createCombatObject()
setCombatParam(combat4, COMBAT_PARAM_TYPE, COMBAT_PHYSICALDAMAGE)
setCombatParam(combat4, COMBAT_PARAM_EFFECT, 127)
setCombatFormula(combat4, COMBAT_FORMULA_LEVELMAGIC, -22.3, 1, -27.5, 1)
