...
setCombatFormula(combat1, COMBAT_FORMULA_LEVELMAGIC, -31.1, 1, -27.2, 1)

local combat2 = createCombatObject()
setCombatParam(combat2, COMBAT_PARAM_TYPE, COMBAT_PHYSICALDAMAGE)
setCombatParam(combat2, COMBAT_PARAM_EFFECT, 79)
setCombatFormula(combat2, COMBAT_FORMULA_LEVELMAGIC, -34.2, 1, -27.2, 1)

local combat3 = createCombatObject()
setCombatParam(combat3, COMBAT_PARAM_TYPE, COMBAT_PHYSICALDAMAGE)
setCombatParam(combat3, COMBAT_PARAM_EFFECT, 79)
setCombatFormula(combat3, COMBAT_FORMULA_LEVELMAGIC, -32.2, 1, -27.1, 1)

local combat4 = createCombatObject()
setCombatParam(combat4, COMBAT_PARAM_TYPE, COMBAT_PHYSICALDAMAGE)
setCombatParam(combat4, COMBAT_PARAM_EFFECT, 79)
setCombatFormula(combat4, COMBAT_FORMULA_LEVELMAGIC, -33.2, 1, -26.2, 1)
