local config = {
efeitoTele = 211, -- efeito q ira aparacer a cada teleport.
...
min = 15100, -- dano minimo
max = 16200, -- dano maximo
...
spell631 = {
start631 = function (cid, target, markpos, hits)
    ...
    addEvent(spell631.start631, config.delay, cid, target, markpos, hits - 1)
   end
}
...
if target then
  spell631.start631(cid, target, getThingPos(cid), config.hits)
  doSendMagicEffect(position1, 134)
  doSendMagicEffect(position2, 38)
end
return true
end