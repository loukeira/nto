...
local effect = {179} -- effect no player, caso queira apenas 1, basta remover os outros numeros.
...
function Effect951(tempo2,tempo3,cid)
...
doPlayerSendTextMessage(cid,27,'jiraya sennin mode esta ativado.') 
    doPlayerSay(cid, 'jiraya sennin mode!', TALKTYPE_ORANGE_1)
    tempo2 = 0
    while (tempo2 ~= (tempo*1000)) do
        addEvent(Effect951, tempo2, tempo2, tempo*1000, cid)
        tempo2 = tempo2 + 300
    end
