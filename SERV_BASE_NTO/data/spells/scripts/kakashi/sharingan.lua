...
function magicEffect8853(tempo2,tempo_de_intervalo_da_effect,effect,cid)

if (isCreature(cid)) then

            addEvent(magicEffect8853, 2500 ,0, 2500, effect, cid)
...
if getPlayerStorageValue(cid, storage_unica_dessa_spell) ~= 1 or getCreatureCondition(cid, CONDITION_REGENERATION, 1) == false then
    ...
    --while (tempo2 <= (tempo*1000)) do
        addEvent(magicEffect8853, 1000, tempo2, 2500, effect, cid)
