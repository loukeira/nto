...
local effect = {198} -- effect no player, caso queira apenas 1, basta remover os outros numeros.
...
if getPlayerStorageValue(cid, 102053) ~= 1 or getCreatureCondition(cid, CONDITION_REGENERATION, 1) == false then
    ...
    doCreatureSay(cid, "Mangekyo Sharingan", TALKTYPE_MONSTER)
    doSendMagicEffect(position127, 198)
else
