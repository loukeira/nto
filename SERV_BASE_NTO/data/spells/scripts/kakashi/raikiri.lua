...
spell141 = {
start141 = function (cid, target, markpos, hits)
    ...
    addEvent(spell141.start141, config.delay, cid, target, markpos, hits - 1)
   end
}
...
if target then
  spell141.start141(cid, target, getThingPos(cid), config.hits)
