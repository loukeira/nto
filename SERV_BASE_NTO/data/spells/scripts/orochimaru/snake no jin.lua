...
local effect = {89} -- effect no player, caso queira apenas 1, basta remover os outros numeros.
...
if getPlayerStorageValue(cid, 102053) ~= 1 or getCreatureCondition(cid, CONDITION_REGENERATION, 1) == false then
    ...
    doCreatureSay(cid, "Snake No Jin!", TALKTYPE_MONSTER)
    doSendMagicEffect(position129, 89)
else
