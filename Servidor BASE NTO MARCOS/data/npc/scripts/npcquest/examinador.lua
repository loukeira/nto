...
selfSay('Hahaha, entao ira fazer o {exame} chunin? Essa é apenas a primeira fase do exame garoto.', cid)
end
---------------------------------------------------------
if(msgcontains(msg, 'exame')) then
selfSay('Tudo bem então, para {confirmar}, vou pegar todas medalhas que voce possue para confirmar que voce fes essas missoes, e lembrese, essa é apenas a primeira fase, hahaha!', cid)
...
selfSay('Muito bom garoto, ja podes avançar essa porta, e veja o que o nosso proximo examinador lhe pedir!', cid)
else
