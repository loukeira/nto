...
---------------------------------------------------------
if(msgcontains(msg, 'como')) then
selfSay('só vc clica naquele pergaminho,mas esta embaralhada vc tera que pega 1 primeira que vim.', cid)
talkState[talkUser] = 1
elseif(msgcontains(msg, 'aaaaa') and talkState[talkUser] == 1) then
