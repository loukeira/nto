...
local effect = {183} -- effect no player, caso queira apenas 1, basta remover os outros numeros.
...
doPlayerSendTextMessage(cid,27,'Shanaro no jutsu esta ativado.') 
    doPlayerSay(cid, 'Shanaro!', TALKTYPE_ORANGE_1)
    tempo2 = 0
