...
setCombatFormula(combat1, COMBAT_FORMULA_LEVELMAGIC, -5, -60, -6, -60, 8, 8, 4.6, 5.3)
...
local position2 = {x=getCreaturePosition(cid).x+4, y=getCreaturePosition(cid).y, z=getCreaturePosition(cid).z}
