...
if target > 0 then
	...
	posTile2 = {{x=pos.x+1,y=pos.y+1,z=pos.z,stackpos=1}, 7526}
	posTile3 = {{x=pos.x+1,y=pos.y,z=pos.z,stackpos=1}, 7523}
	posTile4 = {{x=pos.x+1,y=pos.y-1,z=pos.z,stackpos=1}, 7520}
	posTile5 = {{x=pos.x,y=pos.y-1,z=pos.z,stackpos=1}, 7521}
	posTile6 = {{x=pos.x-1,y=pos.y-1,z=pos.z,stackpos=1}, 7522}
	posTile7 = {{x=pos.x-1,y=pos.y,z=pos.z,stackpos=1}, 7525}
	posTile8 = {{x=pos.x-1,y=pos.y+1,z=pos.z,stackpos=1}, 7501}
	posTile9 = {{x=pos.x,y=pos.y+1,z=pos.z,stackpos=1}, 7500}
...
if isCreature(target) and isPlayer(cid) then
	local effect13 = 1 -- efeito do hit na creatura.
	doAddCondition(target, condition)
	doTargetCombatHealth(cid, target, COMBAT_PHYSICALDAMAGE, -getHit(cid), -getHit(cid), effect13)
end
end
